...
var SliderHandle = Widget.inherit({
  ...
  _centeredTooltipPosition: function _centeredTooltipPosition() {
    ...
    var tooltipCenter = (roundedTooltipOuterWidth - getWidth(this.$element())) / 2;
  ...
  _fitTooltip: function _fitTooltip() {
    ...
    var arrowMaxRight = this._contentLocate.left + getOuterWidth(this._$tooltipContent) - getOuterWidth(this._$tooltipArrow);
