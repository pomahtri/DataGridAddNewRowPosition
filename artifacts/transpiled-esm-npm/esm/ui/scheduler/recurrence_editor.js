...
class RecurrenceEditor extends Editor {
  ...
  _optionChanged(args) {
    ...
    switch (args.name) {
      case 'readOnly':
        (_this$_recurrenceForm = this._recurrenceForm) === null || _this$_recurrenceForm === void 0 ? void 0 : _this$_recurrenceForm.option('readOnly', args.value);
        (_this$_repeatCountEdi = this._repeatCountEditor) === null || _this$_repeatCountEdi === void 0 ? void 0 : _this$_repeatCountEdi.option('readOnly', args.value);
        (_this$_weekEditor = this._weekEditor) === null || _this$_weekEditor === void 0 ? void 0 : _this$_weekEditor.option('readOnly', args.value);
        (_this$_repeatUntilDat = this._repeatUntilDate) === null || _this$_repeatUntilDat === void 0 ? void 0 : _this$_repeatUntilDat.option('readOnly', args.value);
