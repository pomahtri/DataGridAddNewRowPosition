...
export class DateGeneratorBaseStrategy {
  ...
  generate(appointmentAdapter) {
    var itemResources = getResourcesFromItem(this.options.resources, this.options.dataAccessors.resources, this.rawAppointment);
  ...
  normalizeEndDateByViewEnd(rawAppointment, endDate) {
    ...
    var allDay = ExpressionUtils.getField(this.key, 'allDay', rawAppointment);
