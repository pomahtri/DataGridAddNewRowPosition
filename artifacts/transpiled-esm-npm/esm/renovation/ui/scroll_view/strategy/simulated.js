...
export class ScrollableSimulated extends InfernoComponent {
  constructor(props) {
    ...
    this.clampScrollbarWithinContainer = this.clampScrollbarWithinContainer.bind(this);
