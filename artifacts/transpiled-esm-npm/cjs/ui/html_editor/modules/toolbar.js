...
if (_devextremeQuill.default) {
  ...
  var getTargetTableNode = function getTargetTableNode(quill, partName) {
    var _quill$getModule$getT = quill.getModule('table').getTable(),
        _quill$getModule$getT2 = _slicedToArray(_quill$getModule$getT, 2),
        table = _quill$getModule$getT2[0],
        cell = _quill$getModule$getT2[1];
  ...
  ToolbarModule = /*#__PURE__*/function (_BaseModule) {
    ...
    _proto._getFormatHandlers = function _getFormatHandlers() {
      ...
      return {
        ...
        insertHeaderRow: (0, _table_helper.getTableOperationHandler)(this.quill, 'insertHeaderRow'),
        ...
        cellProperties: function cellProperties() {
          var domNode = getTargetTableNode(_this3.quill, 'cell');
          (0, _tableForms.showCellPropertiesForm)(_this3.editorInstance, (0, _renderer.default)(domNode));
        },
        tableProperties: function tableProperties() {
          var domNode = getTargetTableNode(_this3.quill, 'table');
          (0, _tableForms.showTablePropertiesForm)(_this3.editorInstance, (0, _renderer.default)(domNode));
        }
      };
    };
