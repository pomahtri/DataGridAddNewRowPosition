...
exports._setPixelRatioFn = _setPixelRatioFn;
...
function _setPixelRatioFn(value) {
  exports.getPixelRatio = getPixelRatio = value;
} ///#ENDDEBUG
    ...
    virtualItemsCount: function virtualItemsCount() {
      if (_isVirtualMode(this)) {
        ...
        if (this.option(NEW_SCROLLING_MODE) && totalItemsCount !== -1) {
          ...
          var endItemsCount = totalItemsCount - (skip + take);
          return {
            begin: skip,
            end: endItemsCount
          };
