...
var HtmlEditor = _editor.default.inherit({
  ...
  _tableResizingOptionChanged: function _tableResizingOptionChanged(args) {
    var _this$_quillInstance;

    var tableResizingModule = (_this$_quillInstance = this._quillInstance) === null || _this$_quillInstance === void 0 ? void 0 : _this$_quillInstance.getModule('tableResizing');
  ...
  _tableContextMenuOptionChanged: function _tableContextMenuOptionChanged(args) {
    var _this$_quillInstance2;

    var contextMenuModule = (_this$_quillInstance2 = this._quillInstance) === null || _this$_quillInstance2 === void 0 ? void 0 : _this$_quillInstance2.getModule('tableContextMenu');
