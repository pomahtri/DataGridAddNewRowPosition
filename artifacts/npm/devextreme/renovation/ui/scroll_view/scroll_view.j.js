...
var ScrollView = /*#__PURE__*/function (_ScrollViewWrapper) {
  ...
  _proto.scrollTo = function scrollTo(targetLocation) {
    ...
    return (_this$viewRef5 = this.viewRef) === null || _this$viewRef5 === void 0 ? void 0 : _this$viewRef5.scrollTo.apply(_this$viewRef5, arguments);
  };
  ...
  _proto.scrollToElement = function scrollToElement(element, offset) {
    ...
    return (_this$viewRef6 = this.viewRef) === null || _this$viewRef6 === void 0 ? void 0 : _this$viewRef6.scrollToElement.apply(_this$viewRef6, _toConsumableArray(params.slice(0, arguments.length)));
  };

  _proto.scrollHeight = function scrollHeight() {
    var _this$viewRef7;

    return (_this$viewRef7 = this.viewRef) === null || _this$viewRef7 === void 0 ? void 0 : _this$viewRef7.scrollHeight.apply(_this$viewRef7, arguments);
  };

  _proto.scrollWidth = function scrollWidth() {
    var _this$viewRef8;

    return (_this$viewRef8 = this.viewRef) === null || _this$viewRef8 === void 0 ? void 0 : _this$viewRef8.scrollWidth.apply(_this$viewRef8, arguments);
  };

  _proto.scrollOffset = function scrollOffset() {
    var _this$viewRef9;

    return (_this$viewRef9 = this.viewRef) === null || _this$viewRef9 === void 0 ? void 0 : _this$viewRef9.scrollOffset.apply(_this$viewRef9, arguments);
  };

  _proto.scrollTop = function scrollTop() {
    var _this$viewRef10;

    return (_this$viewRef10 = this.viewRef) === null || _this$viewRef10 === void 0 ? void 0 : _this$viewRef10.scrollTop.apply(_this$viewRef10, arguments);
  };

  _proto.scrollLeft = function scrollLeft() {
    var _this$viewRef11;

    return (_this$viewRef11 = this.viewRef) === null || _this$viewRef11 === void 0 ? void 0 : _this$viewRef11.scrollLeft.apply(_this$viewRef11, arguments);
  };

  _proto.clientHeight = function clientHeight() {
    var _this$viewRef12;

    return (_this$viewRef12 = this.viewRef) === null || _this$viewRef12 === void 0 ? void 0 : _this$viewRef12.clientHeight.apply(_this$viewRef12, arguments);
  };

  _proto.clientWidth = function clientWidth() {
    var _this$viewRef13;

    return (_this$viewRef13 = this.viewRef) === null || _this$viewRef13 === void 0 ? void 0 : _this$viewRef13.clientWidth.apply(_this$viewRef13, arguments);
  };

  _proto.toggleLoading = function toggleLoading(showOrHide) {
    var _this$viewRef14;

    return (_this$viewRef14 = this.viewRef) === null || _this$viewRef14 === void 0 ? void 0 : _this$viewRef14.toggleLoading.apply(_this$viewRef14, arguments);
  };

  _proto.isFull = function isFull() {
    var _this$viewRef15;

    return (_this$viewRef15 = this.viewRef) === null || _this$viewRef15 === void 0 ? void 0 : _this$viewRef15.isFull.apply(_this$viewRef15, arguments);
  };
