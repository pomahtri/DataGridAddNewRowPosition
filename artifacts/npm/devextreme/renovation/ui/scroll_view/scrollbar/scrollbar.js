...
var Scrollbar = /*#__PURE__*/function (_InfernoComponent) {
  ...
  _proto.initHandler = function initHandler(event, thumbScrolling, offset) {
  ...
  _proto.moveHandler = function moveHandler(delta, minOffset, maxOffset, thumbScrolling) {
  ...
  _createClass(Scrollbar, [{
    ...
    get: function get() {
      ...
      return this.__getterCache["thumbStyles"] = function () {
        ...
        return _ref = {}, _defineProperty(_ref, _this6.dimension, _this6.scrollSize || THUMB_MIN_SIZE), _defineProperty(_ref, "transform", _this6.isNeverMode ? "none" : _this6.thumbTransform), _ref;
      }();
    }
  }, {
    key: "thumbTransform",
