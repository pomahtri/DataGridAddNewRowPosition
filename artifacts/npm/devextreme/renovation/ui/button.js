  ...
  _createClass(Button, [{
    ...
    get: function get() {
      var _this$props7 = this.props,
          accessKey = _this$props7.accessKey,
          activeStateEnabled = _this$props7.activeStateEnabled,
          children = _this$props7.children,
          className = _this$props7.className,
          disabled = _this$props7.disabled,
          focusStateEnabled = _this$props7.focusStateEnabled,
          height = _this$props7.height,
          hint = _this$props7.hint,
          ...
          pressed = _this$props7.pressed,
          rtlEnabled = _this$props7.rtlEnabled,
          stylingMode = _this$props7.stylingMode,
          tabIndex = _this$props7.tabIndex,
          template = _this$props7.template,
          templateData = _this$props7.templateData,
          text = _this$props7.text,
          type = _this$props7.type,
          useInkRipple = _this$props7.useInkRipple,
          useSubmitBehavior = _this$props7.useSubmitBehavior,
          validationGroup = _this$props7.validationGroup,
