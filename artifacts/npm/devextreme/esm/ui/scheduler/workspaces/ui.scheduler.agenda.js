...
class SchedulerAgenda extends WorkSpace {
  ...
  _makeGroupRows() {
    ...
    var tree = createReducedResourcesTree(this.option('loadedResources'), (field, action) => getDataAccessors(this.option('getResourceDataAccessors')(), field, action), filteredItems);
