...
class AppointmentAdapter {
  ...
  clone() {
    ...
    var result = new AppointmentAdapter(this.key, deepExtendArraySafe({}, this.rawAppointment), options);
...
export var createAppointmentAdapter = (key, rawAppointment, options) => {
