...
class ScrollHelper {
  ...
  isScrollable($element) {
    var that = this;
    return ($element.css(that._overFlowAttr) === 'auto' || $element.hasClass('dx-scrollable-container')) && $element.prop(that._scrollSizeProp) > (that._sizeAttr === 'width' ? getWidth($element) : getHeight($element));
  }
