...
var Form = Widget.inherit({
  ...
  _applyLabelsWidthByCol: function _applyLabelsWidthByCol($container, index, options, layoutManager) {
  ...
  _applyLabelsWidth: function _applyLabelsWidth($container, excludeTabbed, inOneColumn, colCount, layoutManager) {
  ...
  _applyLabelsWidthWithGroups: function _applyLabelsWidthWithGroups($container, colCount, excludeTabbed, layoutManager) {
  ...
  _alignRootSimpleItems: function _alignRootSimpleItems($container, colCount, excludeTabbed, layoutManager) {
  ...
  _applyLabelsWidthWithNestedGroups: function _applyLabelsWidthWithNestedGroups($container, colCount, excludeTabbed, layoutManager) {
    var applyLabelsOptions = {
      excludeTabbed: excludeTabbed
    };
    var colIndex;
