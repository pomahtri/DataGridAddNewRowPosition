...
class Gantt extends Widget {
  ...
  _dataSourceChanged(dataSourceName, data) {
    ...
    if (dataSourceName === GANTT_TASKS) {
      ...
      (_this$_ganttTreeList2 = this._ganttTreeList) === null || _this$_ganttTreeList2 === void 0 ? void 0 : _this$_ganttTreeList2.updateDataSource(validatedData, forceUpdate);
    }
  }
  ...
  _sortAndFilter() {
    ...
    var sortColumn = columns.filter(c => c.sortIndex === 0)[0];
  ...
  _optionChanged(args) {
    ...
    switch (args.name) {
      ...
      case 'selectedRowKey':
        (_this$_ganttTreeList5 = this._ganttTreeList) === null || _this$_ganttTreeList5 === void 0 ? void 0 : _this$_ganttTreeList5.selectRows(GanttHelper.getArrayFromOneElement(args.value));
        break;
      ...
      case 'allowSelection':
        (_this$_ganttTreeList6 = this._ganttTreeList) === null || _this$_ganttTreeList6 === void 0 ? void 0 : _this$_ganttTreeList6.setOption('selection.mode', GanttHelper.getSelectionMode(args.value));
      ...
      case 'height':
        ...
        (_this$_sizeHelper3 = this._sizeHelper) === null || _this$_sizeHelper3 === void 0 ? void 0 : _this$_sizeHelper3.setGanttHeight(getHeight(this._$element));
        break;
