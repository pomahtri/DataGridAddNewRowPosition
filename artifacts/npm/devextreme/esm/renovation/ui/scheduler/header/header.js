...
export class SchedulerToolbar extends BaseInfernoComponent {
  ...
  get step() {
    return getStep(this.props.currentView !== undefined ? this.props.currentView : this.state.currentView);
  }

  get displayedDate() {
    var startViewDate = new Date(this.props.startViewDate);

    if (isMonthView(this.props.currentView !== undefined ? this.props.currentView : this.state.currentView)) {
