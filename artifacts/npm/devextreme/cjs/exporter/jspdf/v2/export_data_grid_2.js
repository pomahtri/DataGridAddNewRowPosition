/**
* DevExtreme (cjs/exporter/jspdf/v2/export_data_grid_2.js)
* Version: 21.2.1
...
var _pdf_utils_v = require("./pdf_utils_v2");
  ...
  return new Promise(function (resolve) {
    dataProvider.ready().done(function () {
      ...
      var _loop = function _loop(rowIndex) {
        ...
        var rowHeight = (0, _type.isDefined)(currentRowInfo.rowHeight) ? currentRowInfo.rowHeight : (0, _pdf_utils_v.calculateRowHeight)(doc, currentRowPdfCells, options.columnWidths);
