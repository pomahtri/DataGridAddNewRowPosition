...
var Popover = _popup.default.inherit({
  _getDefaultOptions: function _getDefaultOptions() {
    return (0, _extend.extend)(this.callBase(), {
      target: undefined,
      shading: false,
      position: (0, _extend.extend)({}, _overlay_position_controller.POPOVER_POSITION_ALIASES.bottom),
  ...
  _initPositionController: function _initPositionController() {
    this._positionController = new _overlay_position_controller.PopoverPositionController(this._getPositionControllerConfig());
  },
