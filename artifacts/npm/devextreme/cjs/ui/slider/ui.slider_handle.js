...
var SliderHandle = _ui.default.inherit({
  ...
  _centeredTooltipPosition: function _centeredTooltipPosition() {
    ...
    (0, _size.setOuterWidth)(this._$tooltipContent, 'auto');
    ...
    (0, _size.setOuterWidth)(this._$tooltipContent, roundedTooltipOuterWidth);
    var tooltipCenter = (roundedTooltipOuterWidth - (0, _size.getWidth)(this.$element())) / 2;
    this._contentLocate.left = -tooltipCenter;

    this._$tooltipArrow.css({
      marginLeft: -(0, _size.getOuterWidth)(this._$tooltipArrow) / 2,
      left: '50%'
    });
  ...
  _fitTooltip: function _fitTooltip() {
    ...
    var arrowMaxRight = this._contentLocate.left + (0, _size.getOuterWidth)(this._$tooltipContent) - (0, _size.getOuterWidth)(this._$tooltipArrow);
