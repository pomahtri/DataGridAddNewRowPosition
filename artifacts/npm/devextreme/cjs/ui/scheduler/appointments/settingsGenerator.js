...
exports.AppointmentSettingsGenerator = exports.DateGeneratorVirtualStrategy = exports.DateGeneratorBaseStrategy = void 0;
...
var DateGeneratorBaseStrategy = /*#__PURE__*/function () {
  ...
  _proto.generate = function generate(appointmentAdapter) {
    var itemResources = (0, _utils.getResourcesFromItem)(this.options.resources, this.options.dataAccessors.resources, this.rawAppointment);
  ...
  _proto.normalizeEndDateByViewEnd = function normalizeEndDateByViewEnd(rawAppointment, endDate) {
    ...
    var allDay = _expressionUtils.ExpressionUtils.getField(this.key, 'allDay', rawAppointment);
  ...
  _proto._getGroupIndices = function _getGroupIndices(appointmentResources) {
    var _this8 = this;
...
var AppointmentSettingsGenerator = /*#__PURE__*/function () {
  function AppointmentSettingsGenerator(options) {
    this.options = options;
    this.appointmentAdapter = (0, _appointmentAdapter.createAppointmentAdapter)(this.options.key, this.rawAppointment);
  }
  ...
  _proto3._prepareAppointmentInfos = function _prepareAppointmentInfos(dateSettings, cellPositions) {
    var _this11 = this;
