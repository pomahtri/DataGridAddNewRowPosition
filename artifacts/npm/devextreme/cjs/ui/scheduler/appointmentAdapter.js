...
exports.createAppointmentAdapter = exports.default = void 0;
...
var AppointmentAdapter = /*#__PURE__*/function () {
  function AppointmentAdapter(key, rawAppointment, options) {
    this.key = key;
  ...
  _proto.getField = function getField(property) {
    return _expressionUtils.ExpressionUtils.getField(this.key, property, this.rawAppointment);
  };

  _proto.setField = function setField(property, value) {
    return _expressionUtils.ExpressionUtils.setField(this.key, property, this.rawAppointment, value);
  };
  ...
  _proto.clone = function clone() {
    ...
    var result = new AppointmentAdapter(this.key, (0, _object.deepExtendArraySafe)({}, this.rawAppointment), options);
  ...
  _createClass(AppointmentAdapter, [{
    ...
    get: function get() {
      return (0, _instanceFactory.getTimeZoneCalculator)(this.key);
    }
  }, {
    key: "isRecurrent",
    get: function get() {
...
var createAppointmentAdapter = function createAppointmentAdapter(key, rawAppointment, options) {
