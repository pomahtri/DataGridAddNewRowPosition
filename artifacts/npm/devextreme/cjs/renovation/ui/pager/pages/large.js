...
var PagesLarge = /*#__PURE__*/function (_BaseInfernoComponent) {
  ...
  _createClass(PagesLarge, [{
    ...
    get: function get() {
      ...
      return this.__getterCache["pages"] = function () {
        var _this2$config;

        var pageIndex = _this2.props.pageIndex;
        ...
        var rtlPageIndexes = (_this2$config = _this2.config) !== null && _this2$config !== void 0 && _this2$config.rtlEnabled ? _toConsumableArray(_this2.pageIndexes).reverse() : _this2.pageIndexes;
