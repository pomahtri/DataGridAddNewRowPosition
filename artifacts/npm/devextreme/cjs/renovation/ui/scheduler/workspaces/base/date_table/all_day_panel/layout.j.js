  ...
  _createClass(AllDayPanelLayout, [{
    ...
    get: function get() {
      return {
        ...
        props: ["className", "viewData", "groupOrientation", "leftVirtualCellWidth", "rightVirtualCellWidth", "topVirtualRowHeight", "bottomVirtualRowHeight", "addDateTableClass", "dataCellTemplate"]
      };
    }
  }, {
    key: "_viewComponent",
