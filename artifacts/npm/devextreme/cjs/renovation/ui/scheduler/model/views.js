...
exports.getCurrentViewConfig = exports.getCurrentViewProps = exports.getCurrentView = void 0;
...
var getCurrentViewConfig = function getCurrentViewConfig(currentViewProps, schedulerProps) {
  ...
  var result = {
    ...
    currentDate: _date.default.trimTime(new Date(schedulerProps.currentDate)),
