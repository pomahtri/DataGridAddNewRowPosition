...
exports.AnimatedScrollbar = exports.viewFunction = exports.BOUNCE_ACCELERATION_SUM = exports.BOUNCE_MIN_VELOCITY_LIMIT = exports.MIN_VELOCITY_LIMIT = exports.ACCELERATION = exports.OUT_BOUNDS_ACCELERATION = void 0;
...
var AnimatedScrollbar = /*#__PURE__*/function (_InfernoComponent) {
  ...
  _createClass(AnimatedScrollbar, [{
    ...
    key: "isReachBottom",
    get: function get() {
      return this.props.reachBottomEnabled && this.props.scrollLocation - this.props.maxOffset <= 0;
    }
  }, {
